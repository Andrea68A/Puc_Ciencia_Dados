...
Este notebook tem como objetivo realizar agregações analíticas, análise temporal e consultas de métricas de desempenho (ranqueamento). É o último a ser executado.
